            ...
            {spin ? (
                ...
                <div className='login-signup'>
                    <div className='login-logo-container'>
                        <div style={{ width: "70px", background: "white", padding: "10px", borderRadius: "10px" }}>
                    ...
                    <div className='login-container'>
                        ...
                        <form className='container'>
                            ...
                            <div className="text-center">
                                <p>Don't have any account? <Link to="/signup" className="login-signup-router text-success">Register</Link></p>
                            </div>
                        </form>
                    </div>
                </div>
