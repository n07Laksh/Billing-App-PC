...
const ShopDetails = () => {
  ...
  return (
    <div className="shop-details d-flex gap-5 align-content-center align-items-center border-end">
      {imagePreview && (
        <div>
      ...
      <div>
        ...
        {GSTIN && <h6 className="shop-name">GST No. {GSTIN}</h6>}
        <div className="shop-address text-muted">
          <i className="fa-solid fa-location-dot me-2 "></i>
          {shopAddress}
        </div>
        <div className="shop-phone">
          <i className="fa-solid fa-phone text-muted me-2"></i>
          {shopContact}
        </div>
        <div className="shop-email">
          <i className="fa-solid fa-at text-muted me-2"></i>
          {user && user.email}
        </div>
      </div>
    </div>
