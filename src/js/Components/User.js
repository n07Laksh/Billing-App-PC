                    ...
                    <div className="user-div user-detail-div">
                        ...
                        <div className='user-child-div'>
                            ...
                            <div className='gst-container my-4'>
                                ...
                                <div className='d-flex justify-content-center'>
                                    <input onChange={(event) => setGSTNum(event.target.value)} type="text" value={GSTNum ? GSTNum : ""} style={{ height: "44px", borderRadius: "18px 0 0 18px",paddingLeft:"10px" }} name='gst-num' id='gst-num' />
                                    <button onClick={fetchGST} className='btn gst-fetch-btn' style={{
